...
import * as weeklyInvoiceBidderEntity from './weekly-invoice-bidder.entity';
import type { WeeklyInvoiceDailyBidder } from './weekly-invoice-daily-bidder.entity';
import * as weeklyInvoiceDailyBidderEntity from './weekly-invoice-daily-bidder.entity';
import type { WeeklyInvoiceDailySource } from './weekly-invoice-daily-source.entity';
import * as weeklyInvoiceDailySourceEntity from './weekly-invoice-daily-source.entity';
...
export class WeeklyInvoice {
  ...
  @OneToMany(
    () => weeklyInvoiceBidderEntity.WeeklyInvoiceBidder,
    (row) => row.weeklyInvoice,
    {
      cascade: true,
    },
  )
  ...
  @OneToMany(
    () => weeklyInvoiceDailySourceEntity.WeeklyInvoiceDailySource,
  ...
  @OneToMany(
    () => weeklyInvoiceDailyBidderEntity.WeeklyInvoiceDailyBidder,
